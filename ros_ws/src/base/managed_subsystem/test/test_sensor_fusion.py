...
import rclpy
from managed_subsystem.sensor_fusion import SensorFusionNode
...
class TestSensorFusionNode(EngelClassTestTemplate):
    def setup_method(self):
        super().setup_method(expected_comm_objects=comm_types, node_to_test=SensorFusionNode)
